...
// Card shape: { id, name, type } — characters may have sight (spaces they can see)
// IDs must be unique across all decks for lookup when in hand.

const forestDeck = [
  { id: 'forest-torch', name: 'Torch', type: CARD_TYPES.ITEM },
  { id: 'forest-rope', name: 'Rope', type: CARD_TYPES.ITEM },
  { id: 'forest-scout', name: 'Scout', type: CARD_TYPES.CHARACTER, sight: 2 },
  { id: 'forest-guide', name: 'Guide', type: CARD_TYPES.CHARACTER, sight: 1 },
  ...
  { id: 'forest-owl', name: 'Owl', type: CARD_TYPES.CHARACTER, sight: 3 },
...
const mountainDeck = [
  ...
  { id: 'mountain-guide', name: 'Guide', type: CARD_TYPES.CHARACTER, sight: 1 },
  { id: 'mountain-endurance', name: 'Endurance', type: CARD_TYPES.ATTRIBUTE },
  { id: 'mountain-lantern', name: 'Lantern', type: CARD_TYPES.ITEM },
  { id: 'mountain-scout', name: 'Scout', type: CARD_TYPES.CHARACTER, sight: 2 },
  { id: 'mountain-cloak', name: 'Warm Cloak', type: CARD_TYPES.ITEM },
  { id: 'mountain-eagle', name: 'Eagle', type: CARD_TYPES.CHARACTER, sight: 3 },
...
const desertDeck = [
  ...
  { id: 'desert-guide', name: 'Guide', type: CARD_TYPES.CHARACTER, sight: 1 },
  { id: 'desert-resolve', name: 'Resolve', type: CARD_TYPES.ATTRIBUTE },
  { id: 'desert-tent', name: 'Tent', type: CARD_TYPES.ITEM },
  { id: 'desert-scout', name: 'Scout', type: CARD_TYPES.CHARACTER, sight: 2 },
  { id: 'desert-scarf', name: 'Scarf', type: CARD_TYPES.ITEM },
  { id: 'desert-camel', name: 'Camel', type: CARD_TYPES.CHARACTER, sight: 2 },
...
const riverDeck = [
  ...
  { id: 'river-ferryman', name: 'Ferryman', type: CARD_TYPES.CHARACTER, sight: 1 },
  { id: 'river-balance', name: 'Balance', type: CARD_TYPES.ATTRIBUTE },
  { id: 'river-hook', name: 'Hook', type: CARD_TYPES.ITEM },
  { id: 'river-scout', name: 'Scout', type: CARD_TYPES.CHARACTER, sight: 2 },
  { id: 'river-float', name: 'Float', type: CARD_TYPES.ITEM },
  { id: 'river-heron', name: 'Heron', type: CARD_TYPES.CHARACTER, sight: 3 },
